...
public class SequenceNumber {
     ...
     * 起始时间戳
     **/
    private final static long START_TIME = 1575740777809L;
    ...
    public SequenceNumber(long dataCenterId) {
        this(dataCenterId, 0x000000FF & getLastIPAddress(), false, 5L, false);
    }

    public SequenceNumber(long dataCenterId, boolean clock, boolean randomSequence) {
     ...
     */
    public SequenceNumber(long dataCenterId, long workerId, boolean clock, long timeOffset, boolean randomSequence) {
